...
class ManipulateTouchEnv(manipulate.ManipulateEnv, utils.EzPickle):
    def __init__(
        ...
        ignore_z_target_rotation=False, touch_mode='binary', touch_visualisation='on_touch',
    ):
    ...
    def _get_obs(self):
        ...
        if self.touch_mode == 'raw':
            ...
            touch_values = [1 if self.sim.data.sensordata[k] != 0.0 else 0 for k, v in self._tsensor_id2name.items()]
...
class HandTouchBlockEnv(ManipulateTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandTouchBlockEnv, self).__init__(
...
class HandTouchEggEnv(ManipulateTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandTouchEggEnv, self).__init__(
...
class HandTouchPenEnv(ManipulateTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandTouchPenEnv, self).__init__(
