...
class ManipulateSimpleTouchEnv(manipulate.ManipulateEnv, utils.EzPickle):
    def __init__(
    ...
    def _get_obs(self):
        ...
        if self.touch_mode == 'raw':
            ...
            for sensor_group in self._tsensor_group_names:
                ...
                print('{}: {}'.format(list(sensor_group.keys())[0], value))
            ...
            for sensor_group in self._tsensor_group_names:
                ...
                print('{}: {}'.format(list(sensor_group.keys())[0], b))
...
class HandSimpleTouchBlockEnv(ManipulateSimpleTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandSimpleTouchBlockEnv, self).__init__(
...
class HandSimpleTouchEggEnv(ManipulateSimpleTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandSimpleTouchEggEnv, self).__init__(
...
class HandSimpleTouchPenEnv(ManipulateSimpleTouchEnv):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
        super(HandSimpleTouchPenEnv, self).__init__(
